/**
 * Local shadcn-style Select primitives built on Radix UI.
 * Dependencies: @radix-ui/react-select, lucide-react, and cn utility.
 */
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-sm font-semibold text-[#6B7280]",
      className,
    )}
    {...props}
  />
