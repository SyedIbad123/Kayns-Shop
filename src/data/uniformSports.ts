...
export const sportUniforms: SportUniform[] = [
  {
    ...
    products: [
      ...
      { label: "Trouser", image: "/frame_11.png", collectionId: 13 },
  ...
  },
  {
    ...
    name: "Football",
    products: [
      { label: "T-Shirt", image: "/frame_2.png", collectionId: 9 },
      { label: "Shorts", image: "/frame_15.png", collectionId: 16 },
      ...
      { label: "Football Trouser", image: "/frame_11.png", collectionId: 13 },
      { label: "Track Jacket", image: "/frame_7.png", collectionId: 21 },
      { label: "Puffer Jacket", image: "/frame_5.png", collectionId: 19 },
      { label: "Zip Top Jacket", image: "/frame_8.png", collectionId: 22 },
      { label: "Sweatshirt", image: "/frame_4.png", collectionId: 18 },
  ...
  },
  {
    ...
    name: "Basketball",
    products: [
      { label: "Basketball Singlet", image: "/frame_9.png", collectionId: 11 },
      { label: "Shorts", image: "/frame_14.png", collectionId: 15 },
      { label: "T-Shirt", image: "/frame_1.png", collectionId: 8 },
      { label: "Polo Shirt", image: "/frame_17.png", collectionId: 12 },
      { label: "Bucket Hat", image: "/bucket_hat.png", collectionId: 3 },
      {
        label: "Performance Cap",
        image: "/flat_peak_cap.png",
  ...
  },
  {
    ...
    name: "Rugby",
    products: [
      { label: "Rugby T-Shirt", image: "/frame_3.png", collectionId: 10 },
      { label: "Polo Shirt", image: "/frame_17.png", collectionId: 12 },
      { label: "Shorts", image: "/frame_16.png", collectionId: 17 },
      { label: "Beanie", image: "/beanies.png", collectionId: 1 },
      { label: "Bucket Hat", image: "/bucket_hat.png", collectionId: 3 },
      { label: "Trucker Cap", image: "/trucker_hat.png", collectionId: 6 },
      { label: "Track Jacket", image: "/frame_7.png", collectionId: 21 },
  ...
  },
  {
    ...
    products: [
      ...
      { label: "Polo Shirt", image: "/frame_17.png", collectionId: 12 },
      { label: "T-Shirt", image: "/netball_tshirt.png", collectionId: 25 },
      { label: "Netball Singlet", image: "/frame_9.png", collectionId: 11 },
      { label: "Honour Cap", image: "/honour_cap.png", collectionId: 24 },
  ...
  },
  {
    ...
    products: [
      { label: "T-Shirt", image: "/frame_1.png", collectionId: 8 },
      { label: "Polo Shirt", image: "/frame_17.png", collectionId: 12 },
      { label: "Trousers", image: "/frame_11.png", collectionId: 13 },
      { label: "Shorts", image: "/frame_15.png", collectionId: 16 },
      { label: "Beanie", image: "/beanies.png", collectionId: 1 },
      {
        label: "Performance Cap",
